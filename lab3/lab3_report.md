...
+ Создан файл playbook1.yml. В нем прописан сценарий для настройки устройств.

<img src="https://user-images.githubusercontent.com/90505004/208766326-807b64d9-f339-4285-a123-5a0651dbb58b.png" height="300">

+ Запущен playbook1. В результате чего он берёт имя роутера из csv файла, сгенерированного Netbox, и присваивает  имя подключенному роутеру.
...
+ Создан playbook2 в котором прописан сценарий, который позволяет собрать серийный номер устройства, а также вносязий информацию в Netbox.

<img src="https://user-images.githubusercontent.com/90505004/208769620-05b30426-b5e4-4a84-bac7-a061840a47f8.png" height="300">

+ Плейбук протестирован.  В результате его выполнения на netbox появилась информация о новом устройстве.


![205513334-df20bcbd-ba38-4271-8942-262901ef4ebf](https://user-images.githubusercontent.com/90505004/208775959-b276f3be-c6a6-4065-a72b-a14612035adc.jpg)
